...
public struct TestScriptMetadataCapability: BackboneElement {
	...
	/// Designated initializer taking all required properties
	public init(capabilities: Reference) {
...
public struct TestScriptRule: BackboneElement {
	...
	/// Designated initializer taking all required properties
	public init(resource: Reference) {
		self.resource = resource
	}
...
public struct TestScriptRuleset: BackboneElement {
	...
	/// Designated initializer taking all required properties
	public init(resource: Reference, rule: [TestScriptRulesetRule]) {
		self.resource = resource
		self.rule = rule
	}
	...
	public init(
		...
		self.init(resource: resource, rule: rule)
		self.`extension` = `extension`
		self.id = id
		self.modifierExtension = modifierExtension
	}
...
public struct TestScriptRulesetRule: BackboneElement {
	...
	/// Designated initializer taking all required properties
	public init(ruleId: FHIRPrimitive<FHIRString>) {
		self.ruleId = ruleId
	}
...
public struct TestScriptSetupActionAssertRuleset: BackboneElement {
	...
	/// Designated initializer taking all required properties
	public init(rulesetId: FHIRPrimitive<FHIRString>) {
