...
public struct SampledData: Element {
	...
	public init(data: FHIRPrimitive<FHIRString>, dimensions: FHIRPrimitive<FHIRPositiveInteger>, origin: Quantity, period: FHIRPrimitive<FHIRDecimal>) {
		self.data = data
	...
	public init(
		...
		self.init(data: data, dimensions: dimensions, origin: origin, period: period)
